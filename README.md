...
|Пиковая скорость|4.22 ПБ (пиковая нагрузка) / 3600 (секунд в часе) = 1.17 ПБ/с = 9.37 Тбит/с|
|Средняя скорость|16.88 ПБ (суточная отдача) / 86400 (секунд в сутках) = 0.195 ПБ/с = 1.56 Тбит/с|
