...
### 4.2 Схема балансировки нагрузки
...
### 4.3 Расчет количества L7-балансировщиков
...
#### 4.3.2 Расчет по лимиту TLS Handshakes
...
#### 4.3.3 Расчет по пропускной способности сети
...
### 4.4 Межсервисная балансировка (Kubernetes)
...
### 4.5 Обеспечение отказоустойчивости
